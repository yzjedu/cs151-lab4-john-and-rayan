...
- It looks like your program is generated by AI. 
- The read me file does not require you to use list
- The use of while through might make your code run forever 
- The algorithm and the code doesnonet much at all. 
### Lab Grade: R
